    ...
    return (
        <div className="w-full flex gap-12 items-center justify-between">
            ...
            <div className="flex-1 p-24 border border-gray-300 rounded-xl space-y-4">
                <h1 className="text-3xl font-bold text-[#151515] text-center">Login</h1>
                ...
                <p className="font-semibold text-center">Have an account? <span><Link to={`/signup`}>Sign In</Link></span></p>
            </div>
        </div>
    );
};
