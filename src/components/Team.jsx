...
export default function Team() {
    ...
    const [slides, setSlides] = useState(
        Array.from({ length: 500 }).map((_, index) => (
            <>
                <div className="mt-24 card  bg-base-100 shadow-xl p-6 hover:transform hover:scale-105 transition ease-in-out hover:cursor-pointer">
                    <div className='flex flex-col items-center justify-center '>
                        <figure><img className="rounded-xl" src="/src/assets/images/team/1.jpg" /></figure>
                        <div className="card-body px-0 text-center items-center">
                            <h2 className="card-title font-bold text-2xl">Electrical System</h2>
                            <p className="text-[#FF3811] font-bold text-xl">Engine Expert</p>
    ...
    return (
        <div className='className="text-center space-y-6"'>
            <div className="space-y-4 text-center">
                ...
                <h1 className="text-[#151515] font-bold text-2xl">Meet Our Team</h1>
